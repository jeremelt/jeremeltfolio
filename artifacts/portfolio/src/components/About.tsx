    ...
    <section id="about" className="py-32 px-6 md:px-12 max-w-[1400px] mx-auto w-full">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
        ...
        <div className="lg:col-span-7 pr-0 lg:pr-12">
          ...
          >
            <p className="text-[20px]">He's a Product Designer with experience in building and improving digital products across ERP systems, logistics, and e-commerce platforms.</p>
            <p className="text-[20px]">With a background in architecture, he brings a structured, systems-thinking approach to solving complex user problems.</p>
            <p className="text-[20px]">He's worked closely with cross-functional teams to design end-to-end experiences, from research and user flows to high-fidelity prototypes.</p>
            <p className="text-[20px]">He's particularly interested in crafting seamless, impactful solutions that work behind the scenes but make a meaningful difference for users.</p>
          </motion.div>
