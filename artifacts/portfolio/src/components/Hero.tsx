    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <motion.div
          ...
          className="w-full"
        >
          <p className="font-sans md:text-2xl text-foreground mb-8 font-extralight text-[20px]">Currently, I’m a Product Designer at RED Comm Indonesia, focused on improving software experiences, such as ERP features, through intuitive design, and AI-driven solutions. I work closely with cross-functional teams to create user flows and high-fidelity prototypes that enhance usability and product impact. </p>
